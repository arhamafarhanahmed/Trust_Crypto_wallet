...
// import box01 from "../assets/box01-removebg-preview.png"
// import box02 from "../assets/box02-removebg-preview.png"
// import box03 from "../assets/box03-removebg-preview.png"
// import main_box from "../assets/main_box-removebg-preview.png"
...
//               {/* Right Image - Using main_box */}
//               <div className="md:w-1/2 relative p-4">
//                 <img
//                   src={main_box || "/placeholder.svg"}
...
//               <div className="mb-6">
//                 <img src={box01 || "/placeholder.svg"} alt="Encrypted Cloud" className="w-24 h-24 object-contain" />
//               </div>
...
//               <div className="mb-6">
//                 <img src={box02 || "/placeholder.svg"} alt="Privacy Shield" className="w-24 h-24 object-contain" />
//               </div>
...
//               <div className="mb-6">
//                 <img src={box03 || "/placeholder.svg"} alt="Alert Flag" className="w-24 h-24 object-contain" />
//               </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            >
              ...
              <div className="mb-6 flex justify-center">
                <img src={box01 || "/placeholder.svg"} alt="Encrypted Cloud" className="w-40 h-40 object-contain" />
              </div>
              <p className="text-gray-700">Use our Encrypted Cloud Backup for increased wallet security.</p>
            </motion.div>
            ...
            >
              <h3 className="text-2xl font-bold mb-6">Zero personal tracking</h3>
              <div className="mb-6 flex justify-center">
                <img src={box02 || "/placeholder.svg"} alt="Privacy Shield" className="w-40 h-40 object-contain" />
              </div>
              <p className="text-gray-700">
                We don't track any personal information, including your IP address or balances.
              </p>
            ...
            >
              <h3 className="text-2xl font-bold mb-6">Proactive alerts for risky transactions</h3>
              <div className="mb-6 flex justify-center">
                <img src={box03 || "/placeholder.svg"} alt="Alert Flag" className="w-40 h-40 object-contain" />
              </div>
              <p className="text-gray-700">Stay safe with alerts for risky address and dApp connections.</p>
            </motion.div>
          </div>
